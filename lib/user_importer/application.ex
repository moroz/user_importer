defmodule UserImporter.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(UserImporter.Auth0Client.WorkerSupervisor, [])
    ...
    opts = [strategy: :one_for_one, name: UserImporter.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    UserImporterWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
